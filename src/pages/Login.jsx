...
export default function Login() {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
        ...
        if (error) throw error;
        // For Google login, redirection is usually handled by Supabase,
        // but in demo mode we need to navigate manually if it returns success immediately.
        // If not in demo mode, the OAuth flow redirects away anyway.
        // We can check if we are still here (demo mode)
        navigate('/');
    } catch (error) {
        toast({
            variant: "destructive",
